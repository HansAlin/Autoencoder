...
from tensorflow.keras.layers import Conv2D, MaxPooling2D, Conv1D, MaxPooling1D, UpSampling1D, LeakyReLU, Conv1DTranspose, Dropout
...
class DenseModel:
  def build(data, filters=[64,32,16], activation_function='relu', latent_size=6, kernel=3, last_activation_function='linear'):
    """
